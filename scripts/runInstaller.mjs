...
const BASE_URL = "https://github.com/Skibidicord/Installer/releases/latest/download/";
const INSTALLER_PATH_DARWIN = "SkibidicordInstaller.app/Contents/MacOS/SkibidicordInstaller";
...
function getFilename() {
    switch (process.platform) {
        case "win32":
            return "SkibidicordInstallerCli.exe";
        case "darwin":
            return "SkibidicordInstaller.MacOS.zip";
        case "linux":
            return "SkibidicordInstallerCli-linux";
        default:
...
async function ensureBinary() {
    ...
    const outputFile = process.platform === "darwin"
        ? join(FILE_DIR, "SkibidicordInstaller")
        : downloadName;
    ...
    if (process.platform === "darwin") {
        ...
        logAndRun(`sudo spctl --add '${outputFile}' --label "Skibidicord Installer"`);
...
try {
    execFileSync(installerBin, {
        ...
        env: {
            ...process.env,
            SKIBIDICORD_USER_DATA_DIR: BASE_DIR,
            SKIBIDICORD_DEV_INSTALL: "1"
        }
    });
} catch {
