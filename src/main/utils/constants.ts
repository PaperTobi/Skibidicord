...
export const DATA_DIR = process.env.SKIBIDICORD_USER_DATA_DIR ?? (
    process.env.DISCORD_USER_DATA_DIR
        ? join(process.env.DISCORD_USER_DATA_DIR, "..", "SkibidicordData")
        : join(app.getPath("userData"), "..", "Skibidicord")
);
