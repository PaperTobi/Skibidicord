...
export const SpotifyStore = proxyLazyWebpack(() => {
    ...
    class SpotifyStore extends Store {
        ...
        public openExternal(path: string) {
            const url = Settings.plugins.SpotifyControls.useSpotifyUris || Skibidicord.Plugins.isPluginEnabled("OpenInApp")
        ...
        seek(ms: number) {
            ...
            return this.req("put", "/seek", {
                ...
                console.error("[SkibidicordSpotifyControls] Failed to seek", e);
