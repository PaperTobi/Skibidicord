        ...
        this.onClick = addClickListener((msg: any, channel, event) => {
            ...
            if (!isDeletePressed) {
                ...
                if (isMe) {
                    ...
                    const NoReplyMention = Skibidicord.Plugins.plugins.NoReplyMention as any as typeof import("../noReplyMention").default;
                    const shouldMention = Skibidicord.Plugins.isPluginEnabled("NoReplyMention")
