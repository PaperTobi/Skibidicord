...
function ThemesTab() {
    ...
    const [themeDir, , themeDirPending] = useAwaiter(SkibidicordNative.themes.getThemesDir);
    ...
    async function refreshLocalThemes() {
        const themes = await SkibidicordNative.themes.getThemesList();
    ...
    async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
        ...
        const uploads = Array.from(files, file => {
            ...
            return new Promise<void>((resolve, reject) => {
                ...
                reader.onload = () => {
                    SkibidicordNative.themes.uploadTheme(name, reader.result as string)
                        .then(resolve)
                        .catch(reject);
                };
                        ...
                        {userThemes?.map(theme => (
                            <ThemeCard
                                ...
                                onDelete={async () => {
                                    ...
                                    await SkibidicordNative.themes.deleteTheme(theme.fileName);
                                    refreshLocalThemes();
                                }}
                                theme={theme}
                            />
