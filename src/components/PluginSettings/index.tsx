...
import { AddonCard } from "@components/SkibidicordSettings/AddonCard";
import { SettingsTab } from "@components/SkibidicordSettings/shared";
...
export function PluginCard({ plugin, disabled, onRestartNeeded, onMouseEnter, onMouseLeave, isNew }: PluginCardProps) {
    ...
    const isEnabled = () => Skibidicord.Plugins.isPluginEnabled(plugin.name);
...
function ExcludedPluginsList({ search }: { search: string; }) {
    ...
    const ExcludedReasons: Record<"web" | "discordDesktop" | "skibidicordDesktop" | "desktop" | "dev", string> = {
        desktop: "Discord Desktop app or Vesktop",
        discordDesktop: "Discord Desktop app",
        skibidicordDesktop: "Vesktop app",
        web: "Vesktop app and the Web version of Discord",
        dev: "Developer version of Skibidicord"
    };
...
export default function PluginSettings() {
    ...
    const pluginFilter = (plugin: typeof Plugins[keyof typeof Plugins]) => {
        ...
        const enabled = Skibidicord.Plugins.isPluginEnabled(plugin.name);
    ...
    const [newPlugins] = useAwaiter(() => DataStore.get("Skibidicord_existingPlugins").then((cachedPlugins: Record<string, number> | undefined) => {
        ...
        DataStore.set("Skibidicord_existingPlugins", existingTimestamps);
    ...
    for (const p of sortedPlugins) {
        ...
        if (isRequired) {
            const tooltipText = p.required || !depMap[p.name]
                ? "This plugin is required for Skibidicord to function."
